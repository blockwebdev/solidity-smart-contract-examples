...
contract VendingMachine {
    ...
    // receive and fallback functions have been added as per error messages:
    // ERROR: Transaction reverted: function selector was not 
    // recognized and there's no fallback nor receive function
